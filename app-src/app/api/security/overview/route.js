/**
 * @file app/api/security/overview/route.js
 * @description Organization Security Overview API endpoint.
 */

import { jsonSuccess, jsonUnauthorized, jsonForbidden } from '@/lib/api-response';
import { getAuthContext } from '@/lib/auth/context';
import { getSecurityOverviewData } from '@/lib/security/command-center';
...
export async function GET(req) {
  ...
  const data = await getSecurityOverviewData(auth.organization.id);

/**
 * @file app/api/security/integrations/route.js
 * @description Organization integration health probe API endpoint.
 */

import { jsonSuccess, jsonUnauthorized, jsonForbidden } from '@/lib/api-response';
import { getAuthContext } from '@/lib/auth/context';
import { getSecurityIntegrationsData } from '@/lib/security/command-center';
...
export async function GET(req) {
  ...
  const data = await getSecurityIntegrationsData(auth.organization.id);

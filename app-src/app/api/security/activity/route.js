/**
 * @file app/api/security/activity/route.js
 * @description Unified security activity timeline API endpoint.
 */

import { jsonSuccess, jsonUnauthorized, jsonForbidden } from '@/lib/api-response';
import { getAuthContext } from '@/lib/auth/context';
import { getSecurityActivityData } from '@/lib/security/command-center';
...
export async function GET(req) {
  ...
  const data = await getSecurityActivityData(auth.organization.id);

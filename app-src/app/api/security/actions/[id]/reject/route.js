/**
 * app/api/security/actions/[id]/reject/route.js
 *
 * POST /api/security/actions/:id/reject
 * Rejects a pending automation action or approval request.
 */
...
export async function POST(request, { params }) {
  try {
    ...
    const updated = await updateApprovalRequestStatus(
      ...
      body.comment || 'Rejected via Security Console'
    );
